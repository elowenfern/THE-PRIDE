...
const TeacherProfile = () => {
  ...
  return (
    <div className="flex">
      <Sideeach onLogout={handleLogout} />
      <main className="flex-1 p-6">
        <section className="bg-white shadow-lg rounded-lg overflow-hidden">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2 bg-gradient-to-br from-purple-500 to-blue-500 text-white flex items-center justify-center rounded-tl-lg rounded-bl-lg p-8">
              <img
            ...
            <div className="md:w-2/3 p-6">
              <h6 className="text-xl font-semibold text-center mb-4">Teacher Information</h6>
              <hr className="mb-4" />
